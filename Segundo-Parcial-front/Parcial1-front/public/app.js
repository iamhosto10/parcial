...
function cuestionario() {
    ...
    let p53 = document.getElementById('p52');


    db.collection("Questions").where(Company, "==", "el numero del id")
        .onSnapshot((querySnapshot) => {
            p1.innerHTML = '';
            p2.innerHTML = '';
            p3.innerHTML = '';
            ...
            querySnapshot.forEach(function (doc) {
                ...
                var res = str.split("|");
                var str1 = doc1.data().Answer1;
                var res1 = str1.split("|");
                var str2 = doc2.data().Answer2;
                var res2 = str2.split("|");
                var str3 = doc3.data().Answer3;
                var res3 = str3.split("|");
                ...
                p12.innerHTML = res1[0];
                p13.innerHTML = res2[0];
                p11.innerHTML = res3[0];
...
function rcuppass() {
    var correo = document.getElementById("correo1");//aqui iria el campo de donde se lee el correo
